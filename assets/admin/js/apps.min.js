...
var handleSlimScroll = function() {
	...
	handleDataTableDefault=function(){//alert($("#data-table").length);
	"use strict";
    ...
    handleSidebarMenus = function() {
        "use strict";
        $(".sidebars .nav > .has-sub > a").click(function() {
    ...
    App = function() {
        ...
        return {
            init: function() {
                handleDraggablePanel(), handleLocalStorage(), handleResetLocalStorage(), handleSlimScroll(), handleSidebarMenus(), handleMobileSidebarToggle(), handleSidebarMinify(), handleMobileSidebar(), handleThemePageStructureControl(), handleThemePanelExpand(), handleAfterPageLoadAddClass(), handlePanelAction(), handelTooltipPopoverActivation(), handleScrollToTopButton(), handlePageContentView(), handleIEFullHeightContent(), handleUnlimitedTabsRender(),handleDataTableDefault()
            }
        }
    }();