				...
				echo form_open_multipart($action,$attributes); ?>
                                <fieldset>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
										<select data-live-search="true" id="to_nameedit" name="to_name" class="form-control " placeholder="Pair Name">
										<option value="">Select</option>
										<?php foreach($currency->result() as $cur){ ?>
										<option value="<?php echo $cur->id;?>"><?php echo $cur->currency_name;?></option>
										<?php } ?>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
										<input type="text" name="buy_rate_value" oninput="process(this)" id="buy_rate_value" class="form-control" placeholder="Rate" value="" />
                                        </div>
                                    </div>
									<div class="form-group">
                                        <label class="col-md-4 control-label">Sell Rate</label>
                                        <div class="col-md-4">
										<input type="text" name="sell_rate_value" oninput="process(this)" id="sell_rate_value" class="form-control" placeholder="Rate" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-4">
										<input type="text" name="lot_size" oninput="process(this)" id="lot_size" class="form-control" placeholder="Lot Size" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Execution</label>
                                        <div class="col-md-4">
										<select data-live-search="true" id="execution" name="execution"  class="selectpicker form-control">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_min_amount" oninput="process(this)" id="bot_min_amount" class="form-control" value="" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_max_amount" oninput="process(this)" id="bot_max_amount" class="form-control" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_minprice_per" oninput="process(this)" id="bot_minprice_per" class="form-control" value="" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_maxprice_per" oninput="process(this)" id="bot_maxprice_per" class="form-control" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_time_min" oninput="process(this)" id="bot_time_min" class="form-control" value="" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_max" oninput="process(this)" id="bot_time_max" class="form-control" value="" />
                                        </div>
                                    </div>
				...
				echo form_open_multipart($action,$attributes); ?>
                                <fieldset>
                                   ...
                                   <div class="form-group">
                                        <label class="col-md-4 control-label">From Currency</label>
                                        <div class="col-md-4">
										<select data-live-search="true" id="from_name" name="from_name" class="selectpicker form-control" placeholder="Pair Name">
									...
									<div class="form-group">
                                        <label class="col-md-4 control-label">To Currency</label>
                                        <div class="col-md-4">
										<select data-live-search="true" id="to_name" name="to_name" class="selectpicker form-control" placeholder="Pair Name">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Lot Size</label>
                                        <div class="col-md-4">
										<input type="text" name="lot_size" id="lot_size" class="form-control" placeholder="Lot Size" value="<?php echo $pair->lot_size; ?>" />
                                        </div>
                                    </div> 
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">API Fetch</label>
                                        <div class="col-md-4">
										<select data-live-search="true" id="data_fetch" name="data_fetch" onchange="change_to_symbol(this.value)" class="selectpicker form-control" placeholder="Pair Name">
                                    ...
                                    <div class="form-group">
										...
										<option <?php if($pair->execution=='coinbase'){echo 'selected';}?> value="coinbase">Coinbase</option>
										<option <?php if($pair->execution=='binance'){echo 'selected';}?> value="binance">Binance</option>
										<option <?php if($pair->execution=='own'){echo 'selected';}?> value="own">Own</option>
										</select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random Amount</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_min_amount" id="bot_min_amount" class="form-control" value="<?php echo $pair->bot_min_amount; ?>" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_max_amount" id="bot_max_amount" class="form-control" value="<?php echo $pair->bot_max_amount; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random price % range</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_minprice_per" id="bot_minprice_per" class="form-control" value="<?php echo $pair->bot_minprice_per; ?>" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_maxprice_per" id="bot_maxprice_per" class="form-control" value="<?php echo $pair->bot_maxprice_per; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random time interval seconds</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_min" id="bot_time_min" class="form-control" value="<?php echo $pair->bot_time_min; ?>" />
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_max" id="bot_time_max" class="form-control" value="<?php echo $pair->bot_time_max; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <div class="col-md-4">
										<select id="bot_status" name="bot_status" class="form-control">
										<option value="1" <?php if($pair->bot_status==1){echo 'selected';}?>>Active</option>
										<option value="0" <?php if($pair->bot_status==0){echo 'selected';}?>>De-active</option>
										</select>
                                        </div>
                                    </div> -->
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        	...
                                        	<select data-live-search="true" id="status" name="status" class="form-control selectpicker">
										<option value="1" <?php if($pair->status==1){echo 'selected';}?>>Active</option>
										<option value="0" <?php if($pair->status==0){echo 'selected';}?>>De-active</option>
										</select>
