<!-- begin #content -->
		...
		?>
			...
			<!--<p class="text-right m-b-10">
				<a href="<?php echo admin_url().'static_content/create';?>" class="btn btn-primary poper" data-placement="top" data-toggle="popover" data-content="Add New Static Content">Add New</a>
			</p>-->
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<div class="col-md-12">
					...
					<?php }else{ ?>
					<div class="panel-body">
						<?php $attributes=array('class'=>'form-horizontal','id'=>'static_content');
        ...
        <!-- ENGLISH START -->
                                  <div id="english">
									<div class="form-group">
                                        ...
                                        <div class="col-md-8">
										<input type="text" name="english_title" id="name" class="form-control" placeholder="Title" value="<?php echo $static_content->english_title; ?>" />
                                        </div>
                                      </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Page</label>
                                        <div class="col-md-8">
										<input type="text" name="englishpage" id="page" class="form-control" placeholder="Page" value="<?php echo $static_content->english_page; ?>" />
                                        </div>
                                    </div>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-8">
										<textarea class="form-control" id="contents" name="englishcontents" rows="20"><?php echo $static_content->english_content; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                          <!--  ENGLISH END -->
...
<!-- //vv -->                       
                                     <div class="form-group">
										...
										<?php $im = $static_content->image; ?>
										<input type="hidden" name="oldimage" id="oldimage" value="<?php echo $static_content->image; ?>" />
										<?php if($static_content->image!='') { ?>
										<img src="<?php echo $im; ?>" style="width:65px;height:65px;" />
										<?php } ?>

                                        </div>
                                    </div>
                                    <span style="margin-left: 180px;"> Upload Banner Image size(515*228 Pixels)</span>
                                    <div class="form-group">
...
$(document).ready(function() {
    $('#datas-table').DataTable( {
        ...
        "order": [[0, "asc" ]],
        "searching": true,
        "ajax": admin_url+"static_content/staticcontent_ajax"
    });
        });
	</script>
	 <script async
