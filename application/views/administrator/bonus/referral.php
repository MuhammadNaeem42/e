    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">Referral Commission</li>
            </ol>
            <!-- end breadcrumb -->
        </div>
    </div>
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
               ...
               <?php echo form_open(); echo form_close();?>
                <?php 
                    $this->load->view("administrator/bonus/referral_list");
                    ?>
            </div>
            <!-- end panel -->
        </div>
            ...
            $(document).on('click','.editable-submit',function(e, params) {
                ...
                $.ajax({
                    ...
                    {                       
                        if(data==1)
                        {
                            window.location.href="https://smdex.com/Th3D6rkKni8ht_2O22/currency";
                        }
                    }
                });
            });
...
$(document).ready(function() {
    $('#datas-table').DataTable( {
        ...
        // "ajax": admin_url+"referral/referral_ajax"
    });
        });
