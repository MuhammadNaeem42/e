<div class="panel-body">
    ...
    <fieldset>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="currency_name" id="currency_name" class="form-control"
                    placeholder="Currency Name" value="<?php echo $tradingfee->currency_name; ?>" readonly />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="currency_symbol" id="currency_symbol" class="form-control"
                    placeholder="Currency Symbol" value="<?php echo $tradingfee->currency_symbol; ?>" readonly />
            </div>
        </div>
        ...
        <!-- <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <?php $im = $tradingfee->image; ?>
                <input type="hidden" name="oldimage" id="oldimage" value="<?php echo $tradingfee->image; ?>" />
                <?php if($tradingfee->image!='') { ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select data-live-search="true" id="status" name="status" class="form-control selectpicker">
                    <option <?php if($tradingfee->status==1){echo 'selected';}?> value="1">Active</option>
                    <option <?php if($tradingfee->status==0){echo 'selected';}?> value="0">De-active
                    </option>
                </select>
            </div>
        </div>
    ...
    <?php } ?> -->
         ...
         <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="maker_fee" id="maker_fee" class="form-control"
                    placeholder="Maker Fee" value="<?php echo $tradingfee->maker_fee; ?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="taker_fee" id="taker_fee" class="form-control"
                    placeholder="Taker Fee" value="<?php echo $tradingfee->taker_fee; ?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="min_withdraw_limit" id="min_withdraw_limit" class="form-control"
                    placeholder="Minimum Withdraw Limit" value="<?php echo $tradingfee->minimum_withdrawfee; ?>" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="max_withdraw_limit" id="max_withdraw_limit" class="form-control"
                    placeholder="Maximum Withdraw Limit" value="<?php echo $tradingfee->maximum_withdrwafee; ?>" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="withdrawfee" id="withdrawfee" class="form-control"
                    placeholder="Withdraw Fees" value="<?php echo $tradingfee->withdrawfee; ?>" />
            </div>
        </div>
       ...
       <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="expiry_date" id="expiry_date" class="datepicker form-control"
                    placeholder="Expiry Date" value="<?php echo date("d-m-Y",$currency->created); ?>" />
            </div>
        </div> -->
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" name="sorting_order" id="sorting_order" class="form-control"
                    placeholder="Ex-1,2" value="<?php echo $tradingfee->sort_order; ?>" />
            </div>
        </div>
