<!-- begin #content -->
		...
		?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Market Info <!--<small>header small text goes here...</small>--></h1>
			<p class="text-right m-b-10">
				<a href="<?php echo admin_url().'coin_list/create';?>" class="btn btn-primary poper" data-placement="top" data-toggle="popover" data-content="Add New Help Center">Add New</a>
			</p>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Market Info</h4>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="datas-table" class="table table-striped table-bordered">
									...
									<?php if($market_info) {
									foreach ($market_info as $key => $val) { $i++;
										$sym = getcryptocurrency($val->currency);
										?>	
										<tr>
											<td><?=$i?></td>
											<td><?=$sym?></td>
											<td>
												<a href="<?=admin_url().'coin_list/edit/'.$val->id?>" data-placement="top" data-toggle="popover" class="poper"><i class="fa fa-pencil text-primary"></i></a>&nbsp;&nbsp;&nbsp;
												<a href="<?=admin_url().'coin_list/delete/'.$val->id?>" data-placement="bottom" data-toggle="popover"  class="poper"><i class="fa fa-trash-o text-danger"></i></a>
											</td>
										</tr>
