		                ...
		                <fieldset>
		                	...
		                	<div class="form-group">
		                  	...
		                  	<div class="form-group">
		                        ...
		                        <div class="col-md-8">										
									<input type="text" name="issue_time" id="issue_time" class="form-control" placeholder="Issue Time" />
		                        </div>
		                  	</div>
		                  	<div class="form-group">
		                        <label class="col-md-2 control-label">Total Supply</label>
		                        <div class="col-md-8">										
									<input type="text" name="total_supply" id="total_supply" class="form-control" placeholder="Total Supply" />
		                        </div>
		                  	</div>
		                  	<div class="form-group">
		                        <label class="col-md-2 control-label">Circulation</label>
		                        <div class="col-md-8">										
									<input type="text" name="circulation" id="circulation" class="form-control" placeholder="Circulation" />
		                        </div>
		                  	</div>
		                  	<div class="form-group">
		                        <label class="col-md-2 control-label">White paper</label>
		                        <div class="col-md-8">										
									<input type="text" name="whitepaper" id="whitepaper" class="form-control" placeholder="White paper" />
		                        </div>
		                  	</div>
		                  	<div class="form-group">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-md-8">
								<input type="text" name="block_explorer" id="block_explorer" class="form-control" placeholder="Block Explorer" />
	                            </div>
	                        </div>
		                  	<div id="announcement">
								<div class="form-group">
		                            ...
		                            <div class="col-md-8">
										<textarea class="form-control" id="contents" name="content" rows="20" placeholder="Project Introduction"></textarea>
		                            </div>
		                      	</div>
		                    </div>
