<!-- begin #content -->
		...
		?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Fiat Withdraw Management <!--<small>header small text goes here...</small>--></h1>
			...
			<div class="row">
				...
				?>
                                ...
                                <hr>
                                <?php if($withdraw->status=='Pending' && $withdraw->payment_method=='bank' || $withdraw->payment_method=='Mollie'){ 
                                ...
                                <a class="btn btn-small btn-success" href="<?php echo admin_url();?>withdraw/pay/<?php echo $withdraw->trans_id;?>" onclick="return confirm('Are you sure you want to transfer amount to User?');" style='margin-left:20px;'>PayNow</a>
                                ...
                                else if($withdraw->status=='Pending' && $withdraw->payment_method=='Paypal')
                                {
                                ?>

                               <a class="btn btn-small btn-success" href="<?php echo admin_url();?>withdraw/paypal_pay/<?php echo $withdraw->trans_id;?>" onclick="return confirm('Are you sure you want to transfer amount to User?');" style='margin-left:20px;'>PayNow ( Paypal )</a>
...
$(document).ready(function() {
    $('#datas-table').DataTable( {
        ...
        "order": [[0, "asc" ]],
        "searching": true,
        "ajax": admin_url+"withdraw/withdraw_ajax"
    });
        });
