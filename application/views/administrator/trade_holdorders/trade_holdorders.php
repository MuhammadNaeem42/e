<!-- begin #content -->
		...
		?>
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active"><?php //echo ucfirst($view); ?> Buy Trade Hold Orders </li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"><?php //echo ucfirst($view); ?> Buy Trade Hold Orders  <!--<small>header small text goes here...</small>--></h1>
				...
				<div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><?php //echo ucfirst($view); ?> Buy Trade Hold Orders</h4>
                        </div>
					<?php if($view=='buy'){ ?>
                       ...
                       <br/>
                            <div class="table-responsive" style="overflow: hidden">
                            	 ...
                            	 <div class="container" id="fromdivee">
   <div class='col-md-3'>
...
$(document).ready(function() {
    var table = $('#datas-table').DataTable( {
        ...
        "order": [[0, "asc" ]],
        "searching": true,
        "ajax": admin_url+"trade_holdorders/buy_ajax"
    });
    var table1 = $('#datas-tables').DataTable( {
        ...
        "order": [[0, "asc" ]],
        "searching": true,
        "ajax": admin_url+"trade_holdorders/sell_ajax"
    });

    $("#datas-table_filter.dataTables_filter").append($("#fromdivee"));
   // $("#datas-tables_filter.dataTables_filter").append($("#todate"));
       ...
       // table.draw();
        table.ajax.url(admin_url+"trade_holdorders/buy_tradepair_ajax/"+fromdatev).load();
    });
    ...
    $("#todate").change(function (e) {
        ...
        var fromdatev=$('#fromdate').val();
        var todatev=$('#todate').val();
        //console.log(admin_url+"trade_holdorders/sell_tradepair_ajax/"+pair1)
        // table.draw();
        table.ajax.url(admin_url+"trade_holdorders/buy_tradepair_ajax/"+todatev).load();
