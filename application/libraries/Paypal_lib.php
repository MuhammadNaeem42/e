...
class paypal_lib {
	...
	function __construct()
	{
		...
		$paypal_mode = $sitesettings->paypal_mode;

		$sanbox = $this->CI->config->item('sandbox');
		$this->paypal_url = ($paypal_mode==0)?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
		...
		// values can be overwritten by the calling script.
       	...
       	// $user_mail = getcurUserEmail();

		// $user_mail = 'sb-ud8ld12904737@business.example.com';

		$businessEmail = decryptIt($sitesettings->paypal_username);
	...
	function paypal_auto_form() 
	{
		...
		echo '<p style="text-align:center;">Please wait, your Token Request is being processed and you will be redirected to the paypal website.</p>' . "\n";
	...
	function paypal_form($form_name='paypal_form') 
	{
		...
		$sitelogo = getSiteName();
		$str = '<p><a class="navbar-brand" href="'.base_url().'">'.$sitelogo.'</a></p>';
