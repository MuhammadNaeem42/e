...
class Paypalp
{
	...
	function details($API_USERNAME, $API_PASSWORD, $API_SIGNATURE, $PROXY_HOST, $PROXY_PORT, $IS_ONLINE, $USE_PROXY = FALSE, $VERSION = '57.0')
	{
		//echo $IS_ONLINE;exit;
		$this->API_USERNAME = $API_USERNAME;
		$this->API_PASSWORD = $API_PASSWORD;
		$this->API_SIGNATURE = $API_SIGNATURE;
		$this->API_ENDPOINT = ($IS_ONLINE == 0)?'https://api-3t.sandbox.paypal.com/nvp':'https://api-3t.paypal.com/nvp';
