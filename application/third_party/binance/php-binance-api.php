...
class API {
	...
	//protected $base = "https://testnet.binance.vision/api/", $wapi = "https://api.binance.com/wapi/", $api_key, $api_secret;
	...
	public function exchangeInfo() {
	 ...
	 public function exchangeInfo_new($symbols = null)
    {
        if (!$this->exchangeInfo) {
            ...
            if ($symbols) {
                ...
                $arr = $this->apiRequest('v3/exchangeInfo?symbols='.$symbols,"POST");
           
            } else {
                $arr = $this->apiRequest("v3/exchangeInfo");
            }
	...
	public function particular_price($symbol) {
		$result = $this->request("v3/ticker/price",["symbol"=>$symbol]);
