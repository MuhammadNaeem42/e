 ...
 class Announcement extends CI_Controller 
 {
 	...
 	function announcement_ajax()
 	{
        ...
        { 
			...
			$query = "SELECT * FROM `blackcube_announcement`".$like." ORDER BY id DESC LIMIT ".$start.",".$length;
			$countquery = $this->db->query("SELECT * FROM `blackcube_announcement`".$like." ORDER BY id DESC");
        ...
        {
        	$query = 'SELECT * FROM `blackcube_announcement` ORDER BY `id` DESC LIMIT '.$start.','.$length;
        	$countquery = $this->db->query('SELECT * FROM `blackcube_announcement` ORDER BY `id` DESC');
        	$users_history = $this->db->query($query);
            $users_history_result = $users_history->result(); 
            $num_rows = $countquery->num_rows();            
        }
